...
@Service("SendDepartmentBalanceOrpakProcess")
@ConfigurationProperties(prefix = "process.jde.send")
@RequiredArgsConstructor
@Slf4j
public class SendDepartmentBalanceOrpakProcess implements IProcess {
	...
	public void run() throws ProcessException {
	    ...
	    log.info("-----------------------------------------------");
	    log.info("Inicio proceso SendDepartmentBalanceOrpakProcess");
	    ...
	    try {
			...
			auditoria.setAction(AuditoriaConstans.ACTION_ORPAK_SEND_DEPARTMENT_BALANCE);
			auditoria.setIdElemento(0L);
			auditoria.setTipoElemento(AuditoriaConstans.TIPO_ELEMENTO_DEPARTAMENTO);
			auditoria.setDescription("Inicio proceso SendDepartmentBalanceOrpakProcess");
	        ...
	        if (pendingMessages != null && !pendingMessages.isEmpty()) {
				...
				auditoriaDos.setAction(AuditoriaConstans.ACTION_ORPAK_SEND_DEPARTMENT_BALANCE);
			...
			auditoriaTres.setAction(AuditoriaConstans.ACTION_ORPAK_SEND_DEPARTMENT_BALANCE);
			...
			auditoriaTres.setDescription(String.format(
	                "Fin proceso envío de cambios de estados de tarjetas a Orpak, Total registros enviados: %d, tiempo de ejecución: %d ms",
            ...
            auditoriaCuatro.setAction(AuditoriaConstans.ACTION_ORPAK_SEND_DEPARTMENT_BALANCE);
