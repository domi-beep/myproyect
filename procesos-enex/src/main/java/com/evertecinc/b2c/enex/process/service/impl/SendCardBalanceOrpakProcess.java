...
@Service("SendCardBalanceOrpakProcess")
@ConfigurationProperties(prefix = "process.jde.send")
@RequiredArgsConstructor
@Slf4j
public class SendCardBalanceOrpakProcess implements IProcess {
	...
	public void run() throws ProcessException {
	    ...
	    try {
			...
			auditoria.setAction(AuditoriaConstans.ACTION_ORPAK_SEND_CARD_BALANCE);
			auditoria.setIdElemento(0L);
			auditoria.setTipoElemento(AuditoriaConstans.TIPO_ELEMENTO_TARJETA);
			auditoria.setDescription("Inicio proceso SendCardBalanceOrpakProcess");
	        ...
	        if (pendingMessages != null && !pendingMessages.isEmpty()) {
				...
				auditoriaDos.setAction(AuditoriaConstans.ACTION_ORPAK_SEND_CARD_BALANCE);
	            ...
	            auditoriaTres.setAction(AuditoriaConstans.ACTION_ORPAK_SEND_CARD_BALANCE);
            ...
            auditoriaCinco.setAction(AuditoriaConstans.ACTION_ORPAK_SEND_CARD_BALANCE);
