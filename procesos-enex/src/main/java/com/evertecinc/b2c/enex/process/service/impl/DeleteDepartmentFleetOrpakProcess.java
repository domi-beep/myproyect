...
@Service("DeleteDepartmentFleetOrpakProcess")
@ConfigurationProperties(prefix = "process.jde.send")
@RequiredArgsConstructor
@Slf4j
public class DeleteDepartmentFleetOrpakProcess implements IProcess {
	...
	public void run() throws ProcessException {
	    ...
	    log.info("-----------------------------------------------");
	    log.info("Inicio proceso DeleteDepartmentFleetOrpakProcess");
	    ...
	    try {
			...
			auditoria.setAction(AuditoriaConstans.ACTION_ORPAK_CHANGE_DEP_AMOUNT);
			auditoria.setIdElemento(0L);
			auditoria.setTipoElemento(AuditoriaConstans.TIPO_ELEMENTO_DEPARTAMENTO);
			auditoria.setDescription("Inicio proceso DeleteDepartmentFleetOrpakProcess");
	        ...
	        if (pendingMessages != null && !pendingMessages.isEmpty()) {
	            ...
	            auditoriaDos.setAction(AuditoriaConstans.ACTION_ORPAK_CHANGE_DEP_AMOUNT);
            ...
            auditoriaCinco.setAction(AuditoriaConstans.ACTION_ORPAK_CHANGE_DEP_AMOUNT);
            auditoriaCinco.setIdElemento(0L);
            auditoriaCinco.setTipoElemento(AuditoriaConstans.TIPO_ELEMENTO_DEPARTAMENTO);
            auditoriaCinco.setDescription(String.format("Fin proceso DeleteDepartmentFleetOrpakProcess, Total registros enviados: %d, tiempo de ejecución: %d ms",successCount, Duration.between(startTime, endTime).toMillis()));
