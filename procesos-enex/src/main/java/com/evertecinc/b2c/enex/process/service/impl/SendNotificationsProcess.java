...
@Service("SendNotificationsProcess")
@ConfigurationProperties(prefix = "process.jde.send")
@RequiredArgsConstructor
@Slf4j
public class SendNotificationsProcess implements IProcess {
	...
	public void run() throws ProcessException {
	    ...
	    log.info("-----------------------------------------------");
	    log.info("Inicio proceso SendNotificationsProcess");
	    ...
	    try {
			...
			auditoria.setAction(AuditoriaConstans.ACTION_ORPAK_ACTION_SEND_NOTIFICATION);
			auditoria.setIdElemento(0L);
			auditoria.setTipoElemento(AuditoriaConstans.TIPO_ELEMENTO_CLIENTE);
			auditoria.setDescription("Inicio proceso SendNotificationsProcess");
	        ...
	        if (pendingMessages != null && !pendingMessages.isEmpty()) {
				...
				auditoriaDos.setAction(AuditoriaConstans.ACTION_ORPAK_ACTION_SEND_NOTIFICATION);
				...
				auditoriaTres.setAction(AuditoriaConstans.ACTION_ORPAK_ACTION_SEND_NOTIFICATION);
            ...
            auditoriaCuatro.setAction(AuditoriaConstans.ACTION_ORPAK_ACTION_SEND_NOTIFICATION);
			...
			auditoriaCuatro.setDescription(String.format(
	                "Fin proceso SendNotificationsProcess, Total registros enviados: %d, tiempo de ejecución: %d ms",
            ...
            auditoriaCinco.setAction(AuditoriaConstans.ACTION_ORPAK_ACTION_SEND_NOTIFICATION);
