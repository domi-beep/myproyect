...
@Service("SendQuantityCardOrpakProcess")
@ConfigurationProperties(prefix = "process.jde.send")
@RequiredArgsConstructor
@Slf4j
public class SendQuantityCardOrpakProcess implements IProcess {
	...
	public void run() throws ProcessException {
	    ...
	    log.info("-----------------------------------------------");
	    log.info("Inicio proceso SendQuantityCardOrpakProcess");
	    ...
	    try {
			...
			auditoria.setAction(AuditoriaConstans.ACTION_ORPAK_SEND_CARD_BALANCE_LT);
			auditoria.setIdElemento(0L);
			auditoria.setTipoElemento(AuditoriaConstans.TIPO_ELEMENTO_TARJETA);
			auditoria.setDescription("Inicio proceso SendQuantityCardOrpakProcess");
	        ...
	        if (pendingMessages != null && !pendingMessages.isEmpty()) {
				...
				auditoriaDos.setAction(AuditoriaConstans.ACTION_ORPAK_SEND_CARD_BALANCE_LT);
				...
				auditoriaTres.setAction(AuditoriaConstans.ACTION_ORPAK_SEND_CARD_BALANCE_LT);
            ...
            auditoriaCuatro.setAction(AuditoriaConstans.ACTION_ORPAK_SEND_CARD_BALANCE_LT);
			auditoriaCuatro.setIdElemento(0L);
			auditoriaCuatro.setTipoElemento(AuditoriaConstans.TIPO_ELEMENTO_TARJETA);
			auditoriaCuatro.setDescription(String.format(
	                "Fin proceso SendQuantityCardOrpakProcess, Total registros enviados: %d, tiempo de ejecución: %d ms",
            ...
            auditoriaCinco.setAction(AuditoriaConstans.ACTION_ORPAK_SEND_CARD_BALANCE_LT);
            auditoriaCinco.setIdElemento(0L);
			auditoriaCinco.setTipoElemento(AuditoriaConstans.TIPO_ELEMENTO_TARJETA);
