...
@Service("SendCardConstraintOrpakProcess")
@ConfigurationProperties(prefix = "process.jde.send")
@RequiredArgsConstructor
@Slf4j
public class SendCardConstraintOrpakProcess implements IProcess {
	...
	public void run() throws ProcessException {
	    ...
	    log.info("-----------------------------------------------");
	    log.info("Inicio proceso SendCardConstraintOrpakProcess");
	    ...
	    try {
			...
			auditoria.setDescription("Inicio proceso SendCardConstraintOrpakProcess");
            ...
            auditoriaTres.setDescription(String.format(
	                "Fin proceso SendCardConstraintOrpakProcess, Total registros enviados: %d, tiempo de ejecución: %d ms",
