...
@Service("SendUpdateCardGPSOrpakProcess")
@ConfigurationProperties(prefix = "process.jde.send")
@RequiredArgsConstructor
@Slf4j
public class SendUpdateCardGPSOrpakProcess implements IProcess {
	...
	public void run() throws ProcessException {
	    ...
	    log.info("-----------------------------------------------");
	    log.info("Inicio proceso SendUpdateCardGPSOrpakProcess");
	    ...
	    try {
			...
			auditoria.setAction(AuditoriaConstans.ACTION_ORPAK_CHANGE_CARDCONSTRAINT);
			auditoria.setIdElemento(0L);
			auditoria.setTipoElemento(AuditoriaConstans.TIPO_ELEMENTO_TARJETA);
			auditoria.setDescription("Inicio proceso SendUpdateCardGPSOrpakProcess (GPS)");
	        ...
	        if (pendingMessages != null && !pendingMessages.isEmpty()) {
				...
				auditoriaDos.setAction(AuditoriaConstans.ACTION_ORPAK_CHANGE_CARDCONSTRAINT);
				auditoriaDos.setIdElemento(0L);
				auditoriaDos.setTipoElemento(AuditoriaConstans.TIPO_ELEMENTO_TARJETA);
				auditoriaDos.setDescription("Total registros pendientes a procesar (GPS): " + pendingMessages.size());
				...
				auditoriaDos.setIdElemento(0L);
				auditoriaDos.setTipoElemento(AuditoriaConstans.TIPO_ELEMENTO_TARJETA);
				auditoriaDos.setDescription("No hay registros pendientes (GPS)");
				auditoriaDos.setSystem(AuditoriaConstans.USUARIO_PROCESO);
			...
			auditoriaDos.setIdElemento(0L);
			auditoriaDos.setTipoElemento(AuditoriaConstans.TIPO_ELEMENTO_TARJETA);
			auditoriaDos.setDescription(String.format(
	                "Fin proceso SendUpdateCardGPSOrpakProcess, Total registros enviados: %d, tiempo de ejecución: %d ms",
			...
			auditoriaTres.setAction(AuditoriaConstans.ACTION_ORPAK_CHANGE_CARDCONSTRAINT);
			auditoriaTres.setIdElemento(0L);
			auditoriaTres.setTipoElemento(AuditoriaConstans.TIPO_ELEMENTO_TARJETA);
			auditoriaTres.setDescription("GPS: "+e.getMessage());
